import java.util.*;
public class cycleDetectionUndirected { // time complexity O(V+E)
    static class Edge{
        int src;
        int dest;
    ...
    public static void createGraph(ArrayList<Edge> graph[]){
        ...
        graph[1].add(new Edge(1,4));     // to break the cycle remove the 1 to 4 or 4 to 1 edge
        ...
        graph[4].add(new Edge(4,1)); // to break the cycle
